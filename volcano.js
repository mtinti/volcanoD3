function volcanoPlot(chartId) {
    var width = 400,
        ...
        yTicks,
        sampleID = "Gene",
        significanceThreshold = 0.5, // significance threshold to colour by
        foldChangeThreshold = 50.0, // fold change level to colour by
        ...
        selection.each(function(data) {
            ...
            circles.selectAll(".dot")
                ...
                .attr('id', function(d) { //console.log(d);
                    return 'prot_'+chartId+'_'+d['Gene_acc'];} )
            ...
            function tipEnter(d) {
                ...
                tooltip.style('visibility', 'visible')
                    ...
                    .html(
                        ...
                        '<strong>' + yColumn + '</strong>: ' + d3.format('.2f')(d[yColumn])
                    );
            }
            ...
            function zoomFunction() {
                ...
                svg.select('#chart'+chartId).selectAll('.threshold')
                    .attr('transform', transform)
